...
def example_driver():
    ...
    expected_U = mdp_rl_implementation.value_iteration(mdp, U)
    print("\nExpected utility:")
    mdp.print_utility(expected_U)

    print("\nFinal policy:")
    policy = get_policy(mdp, U_new)
    mdp.print_policy(policy)
    expected_policy = mdp_rl_implementation.get_policy(mdp, U_new)
    print("\nExpected policy:")
    mdp.print_policy(expected_policy)
